                ...
                <div class="col-lg-8">
                    <div class="card shadow-lg border-0">
                        <div class="card-body p-5 text-center">
                            ...
                            @if (!$isStarted)
                                {{-- KONDISI 1: BELUM WAKTUNYA --}}
                                <div class="py-5">
                                    <div class="h1 text-primary mb-3"><i data-feather="clock"
                                    ...
                                    <div class="h4 fw-bold text-dark">
                                        {{ $periodeAktif->waktu_mulai->format('d F Y - H:i') }} WIB</div>
                                    <hr class="my-4">
                            ...
                            @elseif ($isEnded)
                                ...
                                <div class="py-5">
                                    <div class="h1 text-danger mb-3"><i data-feather="alert-circle"
                                            style="width: 50px; height: 50px;"></i></div>
                                    <h3>Akses Ditutup</h3>
                                    <p class="text-muted">Masa pengambilan SKL secara online telah berakhir. Silakan hubungi
                            ...
                            @else
                                        ...
                                        <div class="col-md-9">
                                            <table class="table table-borderless mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- Catatan: Ganti ke email jika NISN disimpan di kolom email --}}
                                                </tr>
                                                <tr>
                                ...
                                <div class="card bg-light border-0 shadow-sm mb-4">
                                    <div class="card-body p-4 text-center">
                                        <h5 class="text-muted text-uppercase small fw-bold mb-3">Berdasarkan hasil rapat
                                            pleno kelulusan, Anda dinyatakan:</h5>
                                        ...
                                        @else
                                            ...
                                            <p class="text-muted mt-2">Tetap semangat dan jangan menyerah. Silakan hubungi
                                                pihak sekolah.</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                {{-- BOX STATUS ADMINISTRASI & DOWNLOAD --}}
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                @else
                                                    Administrasi belum lengkap/lunas.
                                                    <br><small class="fw-bold text-danger">Ket:
                                                        {{ $skl->keterangan_administrasi ?? 'Silakan hubungi bagian keuangan.' }}</small>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
